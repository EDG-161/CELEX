...
<html>
  ...
  <body>
    ...
    <table class="table table-hover">
         <thead>
            <tr>
              <th scope="col"><a onclick="AcomodarporFecha();">Apellido Paterno</a></th>
                <th scope="col">Apellido Materno</a></th>
          ...
          <tbody>
            <tr>
                <td><a onclick="agregar();" id="etiqueta" style="display: ">+Agregar Alumno</a>  
                    <input type="text" id="ApellidoPaterno" style="display:none" class="form-control" placeholder="Apellido Paterno"></td>
                <td><input type="text" id="ApellidoMaterno" style="display:none" class="form-control" placeholder="Apellido Materno"></td>
                <td><input type="text" id="Nombre" style="display:none" class="form-control" placeholder="Nombre"></td>
                <td><input type="number" id="Edad" style="display:none" class="form-control" placeholder="Edad"></td>                
            ...
            <tr>
              ...
              <td></td>
              <td></td>
              <td><img src="images/basura.png" width="20"></td>
    ...
    <script>
        function agregar(){
            document.getElementById('Edad').style.display='';
