...
<html>
  ...
  <body>
	  				...
	  				<div class="col-md-10">
	  					<div class="content-box-large">
			  				<div class="panel-heading">
					            <div class="panel-title">Registrar Pagos</div>
					        </div>
			  				<div class="panel-body">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <input type="text" class="form-control" name="ApellidoPaterno" placeholder="Apellido Paterno" disabled>
								    </div>
								  </div>
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <input type="text" class="form-control" name="ApellidoMaterno" placeholder="Apellido Materno" disabled>
								    </div>
								  </div>
								  <div class="form-group">
								    <label for="Nombre" class="col-sm-2 control-label">Nombre</label>
								    <div class="col-sm-10">
								      <input type="text" class="form-control" name="Nombre" placeholder="Nombre" disabled>
								    </div>
								  </div>
								  <div class="form-group">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <select class="form-control" id="Asunto" onchange="Showselected();" name="Asunto">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <input type="number" class="form-control" name="clave" readonly value="853">
								    </div>
								  </div>

								  <div class="form-group">
								  	<h5 class="radio-inline"><input type="radio" name="metodo" onclick="deposito();" checked>Depósito</h5>

								  	<h5 class="radio-inline"><input type="radio" name="metodo" onclick="deposito();">Practicaja</h5>

								  	<h5 class="radio-inline"><input type="radio" name="metodo" onclick="Transferencia();">Transferencia</h5>
								  </div>
								  <div class="form-group" id="FolioDiv" style="display:">
								    <label for="Folio" class="col-sm-2 control-label">Folio/ Sucursal</label>
								    <div class="col-sm-10">
								      <input type="number" class="form-control" id="Folio">
								    </div>								  	
								  </div>
								  <div class="form-group" id="AutorizacionDiv" style="display:">
								    <label for="Autorizacion" class="col-sm-2 control-label">Autorización/ Movimiento</label>
								    <div class="col-sm-10">
								      <input type="number" class="form-control" id="Autorizacion">
								    </div>								  	
								  </div>
								  <div class="form-group" id="FolioInternetDiv" style="display:none">
								    <label for="FolioInternet" class="col-sm-2 control-label">Folio Internet</label>
								    <div class="col-sm-10">
								      <input type="number" class="form-control" id="FolioInternet">
								    </div>								  	
								  </div>
    ...
    <script>
    	function deposito(){
    		document.getElementById('FolioDiv').style.display='';
    		document.getElementById('AutorizacionDiv').style.display='';
    		document.getElementById('FolioInternetDiv').style.display='none';
    	}
    	function Transferencia(){
    		document.getElementById('FolioDiv').style.display='none';
    		document.getElementById('AutorizacionDiv').style.display='none';
    		document.getElementById('FolioInternetDiv').style.display='';    		
    	}
    </script>
  </body>
</html>